...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/base64-encoder-decoder.git
   cd base64-encoder-decoder
   ```
...
[![Repo](https://img.shields.io/badge/base64-encoder-decoder-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/base64-encoder-decoder)
